...
class index:
  def GET(self, filter=None):
    ...
    print "filter %s where %s limit %s" % (filter, where, limit)
    print "SELECT DISTINCT position FROM records WHERE %s ORDER BY date, position DESC %s;" % (where, limit)
